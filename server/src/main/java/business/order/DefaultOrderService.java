...
public class DefaultOrderService implements OrderService {
    ...
    /**
     * Injects DAO instances into the service class
     */
    ...
    private Date getCardExpirationDate(String monthString, String yearString) {
        try {
            ...
            //Ensures valid credit card expiration date.
    ...
    private long performPlaceOrderTransaction(
        ...
        try {
            ...
            //Loops through cart items and inserts each LineItem
    ...
    private void validateCustomer(CustomerForm customerForm) {
        ...
        //This method replaces all non-digit characters with an empty string ("")
        ...
        // removes whitespace characters and hyphens from the credit card number
